...
void delfem2::glfw::CViewer2::InitGL()
{
  ...
  glfwSetFramebufferSizeCallback(this->window, delfem2::viewer2::glfw_callback_resize);
  glfwSetKeyCallback(            this->window, delfem2::viewer2::glfw_callback_key);
  glfwSetMouseButtonCallback(    this->window, delfem2::viewer2::glfw_callback_mouse_button);
  glfwSetCursorPosCallback(      this->window, delfem2::viewer2::glfw_callback_cursor_position);
  glfwSetScrollCallback(         this->window, delfem2::viewer2::glfw_callback_scroll);
}
...
void delfem2::glfw::CViewer2::Mat4_MVP_OpenGL(float mMV[16], float mP[16], float asp) const
{
