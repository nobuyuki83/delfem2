    ...
    const double lez[3])
{
  ...
  double x_min = points::Dot3(p0,lex); double x_max = x_min;
  double y_min = points::Dot3(p0,ley); double y_max = y_min;
  double z_min = points::Dot3(p0,lez); double z_max = z_min;
