...
DFM2_INLINE delfem2::CVec3<T> delfem2::Nearst_Origin3_Quad3(
  ...
  //
  const CVec3<T> q01 = Nearest_Origin_Edge(q0, q1);
  ...
  //
  CVec3<T> q12 = Nearest_Origin_Edge(q1, q2);
  ...
  //
  CVec3<T> q23 = Nearest_Origin_Edge(q2, q3);
  ...
  //
  CVec3<T> q30 = Nearest_Origin_Edge(q3, q0);
