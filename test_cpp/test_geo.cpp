...
TEST(mat3, eigen3) {
  ...
  for (int itr = 0; itr < 10000; itr++) {
    ...
    }
    {
      ...
      dfm2::CMat3d UL;
      dfm2::MatMat3(UL.mat, U.mat, L);
      dfm2::CMat3d ULUt;
      dfm2::MatMatT3(ULUt.mat, UL.mat, U.mat);
      dfm2::CMat3d SM;
      SM.SetSymetric(sm);
...
TEST(mat3, svd3) {
  for (int itr = 0; itr < 10000; itr++) {
    ...
    }
    {
      ...
      dfm2::CMat3d UG;
      dfm2::MatMat3(UG.mat, U.mat, G);
      dfm2::CMat3d UGVt;
      dfm2::MatMatT3(UGVt.mat, UG.mat, V.mat);
...
TEST(mat3, rot_comp) {
  for (int itr = 0; itr < 10000; itr++) {
    ...
    M.SetRandom();
    dfm2::CMat3d R;
    dfm2::GetRotPolarDecomp(R.mat, M.mat, 40);
    {
