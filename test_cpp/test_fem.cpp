...
void MakeRandomHex(
    ...
    double aU0[8][3])
{
  aP0[0][0] = -1; aP0[0][1] = -1; aP0[0][2] = -1;
  aP0[1][0] = +1; aP0[1][1] = -1; aP0[1][2] = -1;
  aP0[2][0] = +1; aP0[2][1] = +1; aP0[2][2] = -1;
  aP0[3][0] = -1; aP0[3][1] = +1; aP0[3][2] = -1;
  aP0[4][0] = -1; aP0[4][1] = -1; aP0[4][2] = +1;
  aP0[5][0] = +1; aP0[5][1] = -1; aP0[5][2] = +1;
  aP0[6][0] = +1; aP0[6][1] = +1; aP0[6][2] = +1;
  aP0[7][0] = -1; aP0[7][1] = +1; aP0[7][2] = +1;
