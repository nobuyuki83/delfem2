...
dfm2::opengl::Drawer_MeshColormap shdr0;
...
void draw(GLFWwindow *window) {
  ...
  shdr0.Draw(mP.data(), mMV.data(),0,0.3);
  viewer.SwapBuffers();
  glfwPollEvents();
}
...
int main() {
  ...
  shdr0.colors.assign(colormap, colormap+ncolor);

  shdr0.InitGL();
  shdr0.AddConnectivity(aTri1, GL_TRIANGLES);
  shdr0.SetCoordinates(aXY1,2);
  shdr0.SetValues(aVal);
