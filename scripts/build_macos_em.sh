...
echo "03_texture"
cd docs/03_texture
em++  ../../examples_newgl_glfw/03_texture/main.cpp -o index.html -std=c++11 -DDFM2_HEADER_ONLY=ON  -I"../../include"  -s USE_WEBGL2=1 -s USE_GLFW=3 -s WASM=1 
cd ../../

echo "04_render2texture"
cd docs/04_render2texture
em++  ../../examples_newgl_glfw/04_render2texture/main.cpp -o index.html -std=c++11 -DDFM2_HEADER_ONLY=ON  -I"../../include"  -s USE_WEBGL2=1 -s USE_GLFW=3 -s WASM=1 
cd ../../

echo "05_offscreenprojection"
cd docs/05_offscreenprojection
em++  ../../examples_newgl_glfw/05_OffScreenProjection/main.cpp -o index.html -std=c++11 -DDFM2_HEADER_ONLY=ON  -I"../../include"  -s USE_WEBGL2=1 -s USE_GLFW=3 -s WASM=1 
cd ../../
