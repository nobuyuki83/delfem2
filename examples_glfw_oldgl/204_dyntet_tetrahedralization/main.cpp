...
void Initialize()
{
  ...
  aSTet.clear();
  {
    double len = 3.0;
    aPo3D.resize(4);
    aPo3D[0].p = dfm2::CVector3(-len, +len, -len); aPo3D[0].e = 0; aPo3D[0].poel = 0;
    aPo3D[1].p = dfm2::CVector3(+len, -len, -len); aPo3D[1].e = 0; aPo3D[1].poel = 1;
    aPo3D[2].p = dfm2::CVector3(+len, +len, +len); aPo3D[2].e = 0; aPo3D[2].poel = 2;
    aPo3D[3].p = dfm2::CVector3(-len, -len, +len); aPo3D[3].e = 0; aPo3D[3].poel = 3;
    aSTet.resize(1);
    aSTet[0].v[0] = 0;
    aSTet[0].v[1] = 1;
    aSTet[0].v[2] = 2;
...
void AddRandomPoint()
{
  ...
  for(int itr=0;itr<100;itr++){
    ...
    aPo3D[ip_ins].p = dfm2::CVector3(x0,y0,z0);
    aPo3D[ip_ins].e = -1;
    aPo3D[ip_ins].poel = -1;
    int itet_ins = -1;
    {
