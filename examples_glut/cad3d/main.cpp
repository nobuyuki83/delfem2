...
//	::glClear(GL_COLOR_BUFFER_BIT|GL_DEPTH_BUFFER_BIT);
  ...
  if( cad.imode_edit == CCad3D::EDIT_ADD_POINT_EDGE    ){ DrawMessage_LeftTop("add point edge",2); }
  if( cad.imode_edit == CCad3D::EDIT_SKETCH            ){ DrawMessage_LeftTop("sketch",2); }
  if( cad.imode_edit == CCad3D::EDIT_ADD_CROSS_SECTION ){ DrawMessage_LeftTop("add cross section",2); }
